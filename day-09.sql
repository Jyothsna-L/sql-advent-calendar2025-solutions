...
SELECT
  tinsel_colors.color_name AS tinsel_color,
  light_colors.color_name AS light_color,
  CONCAT(tinsel_colors.color_name,'-',light_colors.color_name) AS combined_color
FROM tinsel_colors
